...
export const WEAPON_SPRITE_CONFIG: Record<string, WeaponSpriteConfig> = {
  "Glock18": { offsetX: 20, offsetY: 40, scale: 1, width: 68, height: 52 },
  "P2000": { offsetX: 9, offsetY: 35, scale: 0.9, width: 71, height: 40 },
  "USP-S": { offsetX: 11, offsetY: 32, scale: 0.9, width: 74, height: 43 },
  "DualBerettas": { offsetX: 7, offsetY: 38, scale: 0.9, width: 73, height: 40 },
  "P250": { offsetX: 16, offsetY: 32, scale: 1, width: 65, height: 52 },
  "FN": { offsetX: 13, offsetY: 31, scale: 1, width: 73, height: 51 },
  "Tec9": { offsetX: 19, offsetY: 19, scale: 1, width: 65, height: 61 },
  "CZ75": { offsetX: 12, offsetY: 26, scale: 0.85, width: 75, height: 49 },
  "DesertEagle": { offsetX: 17, offsetY: 32, scale: 1, width: 75, height: 51 },
  "R8": { offsetX: 18, offsetY: 29, scale: 0.9, width: 76, height: 46 },
  "Ak47": { offsetX: 16, offsetY: 42, scale: 0.95, width: 84, height: 38 },
  "M4A4": { offsetX: 7, offsetY: 48, scale: 0.8, width: 70, height: 35 },
  "M4A4-S": { offsetX: 8, offsetY: 58, scale: 0.9, width: 72, height: 30 },
  "AUG": { offsetX: 16, offsetY: 42, scale: 0.85, width: 70, height: 35 },
  "SG553": { offsetX: 15, offsetY: 40, scale: 0.9, width: 70, height: 35 },
  "GalilAR": { offsetX: 16, offsetY: 56, scale: 0.85, width: 70, height: 30 },
  "FAMAS": { offsetX: 10, offsetY: 41, scale: 0.85, width: 70, height: 35 },
  ...
  "UMP-45": { offsetX: 10, offsetY: 38, scale: 0.85, width: 70, height: 35 },
  "P90": { offsetX: 3, offsetY: 44, scale: 0.8, width: 70, height: 35 },
  "PP-Bizon": { offsetX: 4, offsetY: 48, scale: 0.8, width: 70, height: 30 },
  "Nova": { offsetX: 14, offsetY: 53, scale: 0.9, width: 70, height: 30 },
  "XM1014": { offsetX: 7, offsetY: 45, scale: 0.85, width: 70, height: 30 },
  "Mag7": { offsetX: 17, offsetY: 43, scale: 0.8, width: 70, height: 35 },
  "sawedoff": { offsetX: 14, offsetY: 45, scale: 0.85, width: 70, height: 30 },
  ...
  "G3SG1": { offsetX: 15, offsetY: 56, scale: 0.85, width: 70, height: 30 },
  "M249": { offsetX: 4, offsetY: 54, scale: 0.8, width: 70, height: 30 },
  "Negev": { offsetX: 10, offsetY: 43, scale: 0.85, width: 70, height: 35 },
  "HEGrenade": { offsetX: 20, offsetY: 46, scale: 1, width: 70, height: 45 },
  "Flashbang": { offsetX: 18, offsetY: 33, scale: 1, width: 70, height: 50 },
  "Smoke": { offsetX: 19, offsetY: 35, scale: 1, width: 70, height: 45 },
  "Molotov": { offsetX: 22, offsetY: 42, scale: 1.15, width: 70, height: 50 },
  "Inc": { offsetX: 19, offsetY: 41, scale: 1, width: 70, height: 50 },
  "Decoy": { offsetX: 14, offsetY: 37, scale: 1, width: 70, height: 45 },
  "Zeusx27": { offsetX: 13, offsetY: 29, scale: 1, width: 70, height: 50 },
