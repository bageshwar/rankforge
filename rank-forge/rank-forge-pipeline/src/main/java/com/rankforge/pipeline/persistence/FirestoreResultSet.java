...
/**
 * A simplified wrapper that adapts Firestore query results to the JDBC ResultSet interface.
 * Only implements commonly used methods, others throw UnsupportedOperationException.
 */
public class FirestoreResultSet implements ResultSet {
    private final List<QueryDocumentSnapshot> documents;
    private final Iterator<QueryDocumentSnapshot> iterator;
    private QueryDocumentSnapshot currentDocument;
    private boolean closed = false;
    private int currentRow = -1;

    public FirestoreResultSet(List<QueryDocumentSnapshot> documents) {
    ...
    public Object getObject(String columnLabel) throws SQLException {
        ...
        return currentDocument.get(columnLabel);
    }
    ...
    public int getRow() throws SQLException {
        checkClosed();
        return currentRow + 1; // JDBC row numbers are 1-based
    }
    ...
    private void checkCurrentDocument() throws SQLException {
    ...
    @Override public boolean isBeforeFirst() throws SQLException { return currentRow == -1; }
    @Override public boolean isAfterLast() throws SQLException { return currentRow >= documents.size(); }
    @Override public boolean isFirst() throws SQLException { return currentRow == 0; }
    @Override public boolean isLast() throws SQLException { return currentRow == documents.size() - 1; }
    ...
    @Override public Date getDate(String columnLabel) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Date getDate(int columnIndex) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Time getTime(String columnLabel) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Time getTime(int columnIndex) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Timestamp getTimestamp(String columnLabel) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Timestamp getTimestamp(int columnIndex) throws SQLException { throw new UnsupportedOperationException(); }
    ...
    // Update methods - all throw UnsupportedOperationException
    ...
    @Override public Object getObject(int columnIndex, Map<String,Class<?>> map) throws SQLException { throw new UnsupportedOperationException(); }
    ...
    @Override public Object getObject(String columnLabel, Map<String,Class<?>> map) throws SQLException { throw new UnsupportedOperationException(); }
    ...
    @Override public Date getDate(int columnIndex, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Date getDate(String columnLabel, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Time getTime(int columnIndex, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Time getTime(String columnLabel, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Timestamp getTimestamp(int columnIndex, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public Timestamp getTimestamp(String columnLabel, Calendar cal) throws SQLException { throw new UnsupportedOperationException(); }
    ...
    // Stream methods with long length
    ...
    @Override public <T> T getObject(int columnIndex, Class<T> type) throws SQLException { throw new UnsupportedOperationException(); }
    @Override public <T> T getObject(String columnLabel, Class<T> type) throws SQLException { throw new UnsupportedOperationException(); }
